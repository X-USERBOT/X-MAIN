...
@bot.on(x_cmd(outgoing=True, pattern="carbon(?: |$)(.*)"))
...
async def carbon_api(e):
    ...
    x = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    await x.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await x.edit("`Uploading..`")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your carbon, \n Carbonised by χ-υѕєявσт",
        force_document=True,
...
@bot.on(x_cmd(outgoing=True, pattern="krb"))
@bot.on(sudo_cmd(pattern="krb", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    x = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
...
@bot.on(x_cmd(pattern=f"kar1(?: |$)(.*)", outgoing=True))
@bot.on(sudo_cmd(pattern="kar1(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    """ A Wrapper for carbon.now.sh """
    x = await edit_or_reply(e, "🔲🔲🔲🔲🔲")
    ...
    await x.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await x.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
    ...
    os.remove("./carbon.png")
    # Removing carbon.png after uploading
    await x.delete()  # Deleting msg


@bot.on(x_cmd(pattern=f"kar2(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await x.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await x.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(x_cmd(pattern=f"kar3(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await x.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await x.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(x_cmd(pattern=f"kar4(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await x.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await x.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(x_cmd(pattern=f"rgbk2(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await x.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await x.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(x_cmd(pattern=f"kargb(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await x.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await x.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
