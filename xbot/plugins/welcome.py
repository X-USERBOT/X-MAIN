...
from xbot.sql.welcome_sql import get_current_welcome, add_welcome, rm_welcome, update_welcome
from . import *
...
@bot.on(x_cmd(pattern="savewelcome(?: |$)(.*)"))
...
@bot.on(x_cmd(pattern="cleanwelcome$"))
...
@bot.on(x_cmd(pattern="showwelcome$"))
...
@bot.on(x_cmd(pattern="welcome_note$"))
