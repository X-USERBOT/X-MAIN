...
from . import *
from xbot.sql.filter_sql import get_filter, add_filter, remove_filter, get_all_filters, remove_all_filters
...
@bot.on(x_cmd(pattern="rmallfilters$"))
