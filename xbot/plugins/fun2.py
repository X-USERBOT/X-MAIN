...
@bot.on(x_cmd(pattern="pat ?(.*)", outgoing=True))
...
@bot.on(x_cmd(pattern="join$", outgoing=True))
...
@bot.on(x_cmd(pattern="pay$", outgoing=True))
...
@bot.on(x_cmd(pattern="climb$", outgoing=True))
...
@bot.on(x_cmd(pattern="aag$", outgoing=True))
...
@bot.on(x_cmd(pattern="push$", outgoing=True))
...
@bot.on(x_cmd(pattern="work$", outgoing=True))
...
@bot.on(x_cmd(pattern="suckit$", outgoing=True))
...
@bot.on(x_cmd(pattern="ohh$", outgoing=True))
...
@bot.on(x_cmd(pattern="lovestory$", outgoing=True))
...
@bot.on(x_cmd(pattern="bf$", outgoing=True))
...
@bot.on(x_cmd(pattern="session$", outgoing=True))
...
@bot.on(x_cmd(pattern="cat$"))
@bot.on(sudo_cmd(pattern="cat$", allow_sudo=True))
async def hmm(x):
    if x.fwd_from:
        return
    reactcat = nekos.textcat()
    await eor(x, reactcat)


@bot.on(x_cmd(pattern="why$"))
