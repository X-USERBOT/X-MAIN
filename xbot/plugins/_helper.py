...
@bot.on(x_cmd(pattern="help ?(.*)", outgoing=True))
...
async def yardim(event):
    ...
    if tgbotusername is not None:
        results = await event.client.inline_query(tgbotusername, "xbot_help")
...
@bot.on(x_cmd(pattern="plinfo(?: |$)(.*)", outgoing=True))
