...
@bot.on(x_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
...
@bot.on(x_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(x_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(x_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
