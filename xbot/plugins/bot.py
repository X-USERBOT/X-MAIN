...
@bot.on(x_cmd("kickme", outgoing=True))
async def leave(e):
...
@bot.on(x_cmd(pattern="schd ?(.*)", outgoing=True))
...
CmdHelp("bot").add_command(
    ...
    "schd", "<secs> - <message>", "Sends your message in given secs", "schd 10 - xo"
).add_command(
