...
@bot.on(x_cmd(pattern="ls ?(.*)", outgoing=True))
...
@bot.on(x_cmd(pattern="ls_local$", outgoing=True))
...
@bot.on(x_cmd(pattern="ls_root$", outgoing=True))
...
@bot.on(x_cmd(pattern="ls_saved$", outgoing=True))
...
@bot.on(x_cmd(pattern="rnsaved ?(.*)", outgoing=True))
...
@bot.on(x_cmd(pattern="rnlocal ?(.*)", outgoing=True))
...
@bot.on(x_cmd(pattern="delsave (.*)", outgoing=True))
...
@bot.on(x_cmd(pattern="delocal (.*)", outgoing=True))
...
CmdHelp("managers").add_command(
  "ls_local", None, "Gives the list of downloaded medias in your χ- вσт ѕєяνєя."
).add_command(
  "ls_root", None, "Gives the list of all files in root directory of χbot repo."
).add_command(
  "ls_saved", None, "Gives the list of all files in Saved directory of your χbot server"
).add_command(
