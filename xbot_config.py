...
class Config(object):
    ...
    ALIVE_MSG = os.environ.get("ALIVE_MSG", "⚡ ℓєgєη∂αяу αƒ χ-вσт ⚡")
    ALIVE_PIC = os.environ.get("ALIVE_PIC", "https://telegra.ph/file/cc64741c316f3d720b998.jpg")
    ...
    if AUTH_TOKEN_DATA != None:
        ...
        t_file.close()
    BIO_MSG = os.environ.get("BIO_MSG", "ℓєgєη∂αяу αƒ χ-вσт")
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "X_User_Bot")
    MY_GROUP = os.environ.get("YOUR_GROUP", "X_Discussion")
    ...
    PMPERMIT_PIC = os.environ.get("PMPERMIT_PIC", "https://telegra.ph/file/cc64741c316f3d720b998.jpg")
    REMOVE_BG_API = os.environ.get("REMOVE_BG_API", None)
    SCREEN_SHOT_LAYER_ACCESS_KEY = os.environ.get("SCREEN_SHOT_LAYER_ACCESS_KEY", None)
    STICKER_PACKNAME = os.environ.get("STICKER_PACKNAME", None)
    X_SESSION = os.environ.get("X_SESSION", None)
    SUDO_HANDLER = os.environ.get("SUDO_HANDLER", r"\.")
    SUDO_USERS = set(int(x) for x in os.environ.get("SUDO_USERS", "").split())
    TAG_LOGGER = os.environ.get("TAG_LOGGER", None)
    if TAG_LOGGER: 
        TAG_LOGGER = int(TAG_LOGGER)
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "xbot")
    TEMP_DIR = os.environ.get("TEMP_DIR", None)
    TMP_DOWNLOAD_DIRECTORY = os.environ.get("TMP_DOWNLOAD_DIRECTORY", "./DOWNLOADS/")
    TZ = os.environ.get("TZ", "Asia/Kolkata")
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/LiveToLife/X-Userbot")
